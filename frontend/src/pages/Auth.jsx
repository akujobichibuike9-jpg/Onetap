...
// Liquid Glass Styles - Optimized for performance
const liquidGlassStyles = `
  ...
  @keyframes logo-glow {
    0%, 100% { 
      filter: drop-shadow(0 0 20px rgba(138, 92, 246, 0.4)) drop-shadow(0 0 40px rgba(6, 182, 212, 0.2));
    }
    50% { 
      filter: drop-shadow(0 0 30px rgba(138, 92, 246, 0.6)) drop-shadow(0 0 60px rgba(6, 182, 212, 0.4));
    }
  }
  ...
  .liquid-border:focus-within {
    box-shadow: 0 0 0 2px rgba(138, 92, 246, 0.3);
  }
`;
...
export default function Auth() {
  ...
  const update = (k, v) => { setForm(p => ({ ...p, [k]: v })); setError(''); setSuccess(''); };
  ...
  const handleReset = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        setForm({ firstName: '', lastName: '', email: form.email, phone: '', password: '', otp: '', newPassword: '' });
        setScreen('login');
        navigate('/auth');
      }, 1500);
    } catch (e) { 
  ...
  const backBtn = (to) => (
    <button 
      onClick={() => { setScreen(to); setError(''); setSuccess(''); }} 
      style={{ 
        background: 'rgba(255, 255, 255, 0.05)', 
        backdropFilter: 'blur(10px)',
        border: '1px solid rgba(255, 255, 255, 0.1)', 
  ...
  // Background with Liquid Orbs - Simplified
  ...
  if (screen === 'welcome') return (
    <LiquidBackground>
      <div style={{ 
        ...
        >
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              <span style={{ color: C.success, fontWeight: 700, fontSize: 11, letterSpacing: 0.5 }}>CAC APPROVED</span>
              <span style={{ 
        ...
        <GlassCard style={{ maxWidth: 360, width: '100%', textAlign: 'center' }}>
          <p style={{ color: C.textSec, fontSize: 16, marginBottom: 32, lineHeight: 1.7 }}>
            Buy airtime, data, pay bills & verify KYC all in one place
          </p>
      ...
      <div style={{ minHeight: '100vh', padding: 24, position: 'relative', zIndex: 1 }}>
        <div style={{ maxWidth: 420, margin: '0 auto', paddingTop: 40 }}>
          ...
          <GlassCard>
            ...
            <div style={{ marginBottom: 20 }} className="liquid-border">
        ...
        <div style={{ maxWidth: 420, margin: '0 auto', paddingTop: 20 }}>
          ...
          <GlassCard>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 16 }}>
              <div className="liquid-border" style={{ position: 'relative' }}>
            ...
            <div style={{ marginBottom: 16 }} className="liquid-border">
              <div style={{ position: 'relative' }}>
                <Mail size={18} color={C.textMuted} style={{ position: 'absolute', left: 16, top: '50%', transform: 'translateY(-50%)', zIndex: 1 }} />
                <input 
                  type="email" 
            ...
            <div style={{ marginBottom: 24 }} className="liquid-border">
              <div style={{ position: 'relative' }}>
                <Lock size={18} color={C.textMuted} style={{ position: 'absolute', left: 16, top: '50%', transform: 'translateY(-50%)', zIndex: 1 }} />
                <input 
                  type={showPwd ? 'text' : 'password'} 
        ...
        <div style={{ maxWidth: 420, margin: '0 auto', paddingTop: 40 }}>
          ...
          <GlassCard>
            ...
            <div style={{ 
              ...
              padding: 14, 
              marginBottom: 20,
              boxShadow: '0 4px 20px rgba(138, 92, 246, 0.1)',
            }}>
